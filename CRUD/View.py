...
def update_console():
    read_console()
    while(True):
        print("Pilih nomor buku yang akan di update bro")
        no_buku = int(input("Nomor Buku: "))
        data_buku = Operasi.read(index=no_buku)
        ...
        if data_buku:
            ...
            print("nomor tidak valid kocakk , ulang!")
    ...
    while(True):
        # data yang ingin diupdate
        print("\n"+"="*100)
        print("Silahkan pilih data yang ingin diedit bro")
        print(f"1. Judul\t: {judul:.40}")
        print(f"2. Penulis\t: {penulis:.40}")
        print(f"3. Tahun\t: {tahun:4}")
                ...
                while(True):
                    try:
                        ...
                        if len(str(tahun)) == 4:
                            ...
                            print("tulis tahun yang bener kocakkk, tulis ulang sana!")    
                    except:
                        print("tahun harus angka kocak, isi yang bener!!")
        ...
        print(f"2. Penulis\t: {penulis:.40}")
        print(f"3. Tahun\t: {tahun:4}")
        is_done = input("Apakah data sudah diedit bro(y/n)? ")
        if is_done == "y" or is_done == "Y":
            break
